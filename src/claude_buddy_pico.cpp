...
//
// Pico Buddy main firmware.
//
// This file stays as a single translation unit so BLE, persistence, UI state,
// and input handling can be debugged together on real hardware. Navigate by
// section: constants, state, storage helpers, BLE event handlers, UI
